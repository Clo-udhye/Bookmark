   ...
   $("#comment_delete").click(function() {
      ...
      if(comment_delete_confirm == true){
       ...
       <table>
          <tr>
             ...
             <td >
                <table width="620" height="50">
                   <tr >
                      <td class="line" width="150">작성자 : <%=nickname %></td>
                      <td class="line" width="180">작성 일자 : <%= date %></td>
                      <td class="line" width="100">조회수 : <%=hit %></td>
                      <td rowspan="2">
                      <table>
                      ...
                      <td>
                         <!-- <div id="vertical1">
                            <div class="wrap"> 
                               ...
                               <textarea  cols="80" rows="10" required wrap="hard" id="board_content" style="border:none;" <%=BoardUseq_match %>><%=content %></textarea>
                               <!-- </td></tr></table>
                            </div>
                         </div>  -->
                     </td>
                      ...
                      <td>
                         <div id="vertical2">
                            <div class="wrap">
                               ...
                               <tr>
                                  <th class="line" width="80" >별명</th><th width="300">내용</th><th>일시</th><th style="padding-left : 5px;">비고</th>
                               </tr>
                                  <%= commentHTML %>
          ...
          <tr>
          <td>
             <table height="100" width="500" border="1px">
                <tr>
                   <td  width="80">
                       <%=likey_button %>
                   </td>
